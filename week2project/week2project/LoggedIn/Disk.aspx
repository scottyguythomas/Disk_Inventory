...
<asp:Content runat="server" ContentPlaceHolderID="BodyPlaceholder">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<asp:ValidationSummary ValidationGroup="Edit" CssClass="center-block text-center text-danger" ID="EditSummary" runat="server" DisplayMode="List" />
			<asp:ValidationSummary ValidationGroup="Insert" CssClass="center-block text-center text-danger" ID="InsertSummary" runat="server" DisplayMode="List" />

			<asp:ListView ID="DiskListView" runat="server" DataKeyNames="Disk_ID" DataSourceID="MyDataSource"
